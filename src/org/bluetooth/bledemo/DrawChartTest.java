...
public class DrawChartTest extends View{
	
	private int CHARTH = 600;//表格纵向的高
	private int CHARTW = 600;//图表横向的宽
	private int OFFSET_LEFT = 70;//与左边框的距离
	private int OFFSET_TOP = 80;//与上边框的距离
	private int TEXT_OFFSET = 20;//左侧数字的间距
	private int X_INTERVAL = 1;//
	private BluetoothGattCharacteristic mCharacteristic = null;
	private int VOLTAGE;
	
	private List<Point> plist;

	public DrawChartTest(Context context) {
		super(context);
