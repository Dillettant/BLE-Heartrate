...
public class BleDefinedUUIDs {
	...
	public static class Service {
		...
		final static public UUID HEART_RATE_LEVEL         = UUID.fromString("0000FFE0-0000-1000-8000-00805f9b34fb");
	};
	...
	public static class Characteristic {
		...
		final static public UUID SERIAL_PORT              = UUID.fromString("0000FFE1-0000-1000-8000-00805f9b34fb");
	}
