...
public class HRDemoActivity extends Activity {
	...
	final static private UUID mHeartRateCharacteristicUuid = BleDefinedUUIDs.Characteristic.SERIAL_PORT;//
	final static private UUID mHeartRateServiceLevelUuid = BleDefinedUUIDs.Service.HEART_RATE_LEVEL;
	...
	private void startSearchingForHr() {
		...
		// Heart Rate service
		final UUID[] uuids = new UUID[] { mHeartRateServiceLevelUuid };//
	...
	private void getHrService() {
		...
		mBTService = mBTGatt.getService(mHeartRateServiceLevelUuid);//
